...
Oferim servicii de transport internațional rapide, sigure și adaptate nevoilor tale. Oriunde ai nevoie, Trans Prima livrează cu profesionalism.
          ...
          <div className="flex flex-row gap-5">
            ...
            <Button size="lg" className="gap-4 text-lg px-6 py-6 hover:scale-105 transition-transform duration-200 hidden md:flex" onClick={() => document.getElementById('servici')?.scrollIntoView({ behavior: 'smooth' })}> 
